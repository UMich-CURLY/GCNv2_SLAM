...
int main(int argc, char **argv)
{
    ...
    {
        cerr << endl
             << "Usage: ./rgbd_gcn path_to_vocabulary path_to_settings path_to_sequence path_to_association" << endl;
        return 1;
    }
...
#if defined COMPILEDWITHC11 || defined COMPILEDWITHC14 || defined COMPILEDWITHC17
